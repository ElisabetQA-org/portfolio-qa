...
🔗 [Ver Web Portfolio QA](https://elisabetqa.github.io/portfolio-qa/)
...
- Proyecto Supabase (requiere acceso): [Supabase Project](https://upxlzrmobsseflrmesgq.supabase.co)  

## 🗄 API de Formulario
Se ha generado una API que permite agregar, editar, consultar y eliminar datos de la base de datos creada en supabase.
- URL API (requiere acceso): [Supabase API](https://upxlzrmobsseflrmesgq.supabase.co/rest/v1/form portfolio)  
- Documentación de la API: [Documentación API](https://github.com/ElisabetQA/portfolio-qa/blob/main/apidoc.html) 
---
...
### Pruebas de API
- Colección en POSTMAN (requiere acceso): [POSTMAN Collection](https://elisabetqa-5019574.postman.co/workspace/Api-Form-Portfolio~d033fcf8-2823-4f2d-bd51-4e9c7a605655/collection/53495488-d1c2c844-971d-4662-b883-048a5477d8ae?action=share&source=copy-link&creator=53495488) 
...
## 👩‍💻 Autora
**Elisabet García García – QA**  
[🔗 LinkedIn](https://www.linkedin.com/in/elisabet-garcia-garcia/)
